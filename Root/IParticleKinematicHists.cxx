...
TheAccountant::IParticleKinematicHists::IParticleKinematicHists (std::string name) :
...
StatusCode TheAccountant::IParticleKinematicHists::initialize() {
  m_pt           = book(m_name, "pt",       m_particleType + " p_{T} [GeV]", 100, 0, 300.);
  //temp changes bounds from 120, 0, 3000 to 100, 0 , 300
...
StatusCode TheAccountant::IParticleKinematicHists::execute( const xAOD::IParticle* particle, float eventWeight ) {
  //basic
